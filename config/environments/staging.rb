Rails.application.configure do
  ...
  config.force_ssl = false # false purposefully as it would make local dev difficult for front-end
  ...
  # config.active_job.queue_name_prefix = "operationcode_backend_#{Rails.env}"
